...
entity krnl_vmul_store_output is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of krnl_vmul_store_output is 
...
attribute shreg_extract : string;
    ...
    signal outStream_read_reg_102 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal gmem2_addr_reg_107 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln18_fu_92_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln_fu_82_p4 : STD_LOGIC_VECTOR (61 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state71) and (m_axi_gmem2_0_BVALID = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then
                gmem2_addr_reg_107 <= sext_ln18_fu_92_p1;
                outStream_read_reg_102 <= outStream_dout;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem2_0_AWREADY, m_axi_gmem2_0_WREADY, m_axi_gmem2_0_BVALID, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state71, ap_block_state1)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((m_axi_gmem2_0_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
            ...
            when ap_ST_fsm_state71 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state71) and (m_axi_gmem2_0_BVALID = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state71;
                end if;
    ...
    ap_ST_fsm_state71_blk_assign_proc : process(m_axi_gmem2_0_BVALID)
    begin
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, out_r_empty_n, outStream_empty_n)
    begin
                ap_block_state1 <= ((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (outStream_empty_n = ap_const_logic_0) or (out_r_empty_n = ap_const_logic_0));
    end process;


    ap_done_assign_proc : process(ap_done_reg, m_axi_gmem2_0_BVALID, ap_CS_fsm_state71)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state71) and (m_axi_gmem2_0_BVALID = ap_const_logic_1))) then 
    ...
    ap_ready_assign_proc : process(m_axi_gmem2_0_BVALID, ap_CS_fsm_state71)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state71) and (m_axi_gmem2_0_BVALID = ap_const_logic_1))) then 
    ...
    gmem2_blk_n_B_assign_proc : process(m_axi_gmem2_0_BVALID, ap_CS_fsm_state71)
    begin
    ...
    m_axi_gmem2_0_AWADDR <= gmem2_addr_reg_107;
    ...
    m_axi_gmem2_0_AWVALID_assign_proc : process(m_axi_gmem2_0_AWREADY, ap_CS_fsm_state2)
    begin
        if (((m_axi_gmem2_0_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    m_axi_gmem2_0_BREADY_assign_proc : process(m_axi_gmem2_0_BVALID, ap_CS_fsm_state71)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state71) and (m_axi_gmem2_0_BVALID = ap_const_logic_1))) then 
    ...
    m_axi_gmem2_0_WDATA <= outStream_read_reg_102;
    ...
    m_axi_gmem2_0_WVALID_assign_proc : process(m_axi_gmem2_0_WREADY, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) and (m_axi_gmem2_0_WREADY = ap_const_logic_1))) then 
    ...
    outStream_read_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
    ...
    begin
        ...
        sext_ln18_fu_92_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_fu_82_p4),64));

    trunc_ln_fu_82_p4 <= out_r_dout(63 downto 2);
end behav;
