...
reg    out_r_blk_n;
reg    outStream_blk_n;
reg   [31:0] outStream_read_reg_102;
reg    ap_block_state1;
reg   [63:0] gmem2_addr_reg_107;
wire  signed [63:0] sext_ln18_fu_92_p1;
wire   [61:0] trunc_ln_fu_82_p4;
reg   [70:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state71) & (m_axi_gmem2_0_BVALID == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state71) & (m_axi_gmem2_0_BVALID == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((m_axi_gmem2_0_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_state1 = ((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (outStream_empty_n == 1'b0) | (out_r_empty_n == 1'b0));
end
...
assign m_axi_gmem2_0_AWADDR = gmem2_addr_reg_107;
...
assign m_axi_gmem2_0_WDATA = outStream_read_reg_102;
...
assign sext_ln18_fu_92_p1 = $signed(trunc_ln_fu_82_p4);

assign trunc_ln_fu_82_p4 = {{out_r_dout[63:2]}};

endmodule //krnl_vmul_store_output
