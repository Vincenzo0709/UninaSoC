...
row = config.loc["RANGE_ADDR_WIDTH"] # Reads the row of the csv Configuration file containing the Ranges' Width
retrieved = row.to_string(index = False) # Gets row as String without the index
...
row = config.loc["NUM_MI"] # Reads the row of the csv Configuration file containing the Master Number
retrieved = row.to_string(index = False) # Gets row as String without the index
Master_Number = int(retrieved) # Gets the Number of Masters as Integer
# Let's retieve the Slaves' Names
row = config.loc["SLAVE_NAMES"] # Reads the row of the csv Configuration file containing the Slave Names
retrieved = row.to_string(index = False) # Gets row as String without the index
